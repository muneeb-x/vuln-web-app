...
14. `.claude/specs/continue-with-google.md` + `.claude/specs/continue-with-google-plan.md` — Continue with Google / OAuth 2.0 (v1.0.3 feature); plain-English guide in `docs/continue-with-google-explained.md`
